...
const mapDispatchToProps = dispatch => {
  return {
    onIngredientAdded: ingName =>
      dispatch({ type: actionsTypes.AddIngredient, ingredientName: ingName }),
    onIngredientRemoved: ingName =>
      dispatch({ type: actionsTypes.RemoveIngredient, ingredientName: ingName })
  };
};
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ErrorHandler(BurgerBuilder, axiosInstance));
